...
export const MusicTheme = () => {
  ...
  return (
    <>
      <div className="pt-[100px] pb-[120px] bg-[url(/assets/images/bg-demo-1.png)] bg-no-repeat bg-center bg-cover lg:bg-auto">
        <div className="container">
          ...
          >
            <SwiperSlide>
              <Link href="#" className="block lg:w-[960px] w-full mx-auto text-center">
                ...
                <div className="font-2 text-[20px] text-white mt-[20px]">
                  mmorita1 (Kayo)
                </div>
              </Link>
            </SwiperSlide>
